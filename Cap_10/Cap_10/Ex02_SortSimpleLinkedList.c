...
void insere_aluno_no_topo_lista(Student_Data**, Student_Data*);
...
int main()
{
    ...
    {   // cria aluno
        ...
        insere_aluno_no_topo_lista(&ListHead, NewStudent);
    }
    // Apresenta Lista
    printf("===== Lista ====\n");
...
void insere_aluno_no_topo_lista(Student_Data** ListHead, Student_Data *NewStudent)
{
        if(*ListHead == NULL)
        {
            *ListHead = NewStudent;
